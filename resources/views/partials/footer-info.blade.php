        ...
        <div class="row g-5">
            <div class="col-md-4 col-lg-4 col-xl-4">
                <div class="footer-item d-flex flex-column">
                    ...
                    <p href=""><i class="fas fa-home me-2"></i>Mamonal, Cartagena de Indias, Colombia.</p>
                    <p href=""><i class="fas fa-envelope me-2"></i> operaciones.coltagasdelcaribe@gmail.com</p>
                    <p href=""><i class="fas fa-envelope me-2"></i> gerencia@coltagas.com.co</p>
                </div>
            </div>
            <div class="col-md-4 col-lg-4 col-xl-4">
